...
import { LanguageSelector3 } from "@/components/LanguageSelector3";
import { ImageUpload1 } from "@/components/ImageUpload1";
import { ProcessingStatus3 } from "@/components/ProcessingStatus3";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background to-secondary/20 py-12 px-4">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {/* Processing Status */}
        {isProcessing && (
          <ProcessingStatus3 steps={processingSteps} />
        )}

        {/* Audio Player */}
        {audioUrl && (
          <AudioPlayer1 audioUrl={audioUrl} />
        )}
      </div>
    </div>
  );
