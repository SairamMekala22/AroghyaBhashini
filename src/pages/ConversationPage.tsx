...
const ConversationPage = () => {
  ...
  const [activeSpeaker, setActiveSpeaker] = useState<"doctor" | "patient">(
    "doctor"
  );
  const {
    doctorLanguage,
  ...
  const handleRecordingComplete = async (audioBlob: Blob) => {
    ...
    try {
      ...
      const sourceLanguage =
        activeSpeaker === "doctor" ? doctorLanguage : patientLanguage;
      const targetLanguage =
        activeSpeaker === "doctor" ? patientLanguage : doctorLanguage;
      ...
      const newMessage: Message = {
        ...
        translatedText:
          response.translated_text || "Translation in progress...",
    ...
    <div className="min-h-[calc(100vh-4rem)] bg-gradient-subtle p-4">
      <div className="container mx-auto max-w-6xl">
        <div className="mb-6">
          ...
          <p className="text-muted-foreground">{t("conv.subtitle")}</p>
        </div>
            ...
            <Card className="shadow-medium border-2 border-border">
              ...
              <CardContent>
                <Tabs
                  value={activeSpeaker}
                  onValueChange={(val) =>
                    setActiveSpeaker(val as "doctor" | "patient")
                  }
                >
